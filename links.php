...
<head>
    ...
    <meta charset="UTF-8">
    <title>Links | Resica Falls Scout Reservation</title>
    <link rel="stylesheet" href="_css/links.css">
    <script src="https://kit.fontawesome.com/8dd4382229.js" crossorigin="anonymous"></script>
    <link rel="icon" href="_img/favicon.ico?" />
</head>
<body>
    <img id="logo" src="_img/logo.svg" alt="Resica Falls Logo">

    <div id="name">@ResicaFalls</div>

    <div id="socials">
        <a href="https://www.facebook.com/resicafalls" target="_blank">
            <i style="line-height: 38px;" class="fa fa-facebook-f circle" aria-hidden="true"></i>
        </a>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-96198154-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-96198154-2');
    </script>
</body>
</html>