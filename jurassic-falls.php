...
<html lang="en">
	...
	<body>
		...
		<div class="container content">
			<div class="row">
				<div class="col">
                    <h1>Summer 2019: Jurassic Falls</h1>
				</div>
            </div>
            <div class="row">
					...
					<ul>
						...
						<li><strong>Camp Improvements for 2019</strong>
							<ul>
								...
								<li>New doors, windows, and internal walls were installed at the STEM Center, and a new walkway was built outside of Unami Lodge &ndash; courtesy of Troop 542 (Baden Powell District)</li>
								<li>Improved unit check-in with the camp leadership team at the Resica Elementary School</li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<div class="row">
				<div class="col alert alert-highlight">
					<h5>WHAT LEADERS &amp; UNITS ARE SAYING</h5>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
            ...
            <div class="row">
                <div class="col alert alert-highlight">
					<h5>Celebrations from the Summer</h5>
				</div>
            </div>
            <div class="row">
                <div class="col">
