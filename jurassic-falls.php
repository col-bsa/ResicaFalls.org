...
<html lang="en">
	...
	<body>
		...
		<div class="container content">
			<div class="row">
				<div class="col">
                    <h1>A Summer Camping Adventure Millions of Years in the Making...</h1>
            ...
            <div class="row">
				<div class="col-md-12">
                    <h5>Find out more details in January 2019 when our Program Guide is released!</h5>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
					<img class="img-fluid" src="_img/programs/theme/Jurassic-Photo6Pack-min.png" alt="">
                </div>
            </div>
		</div>
