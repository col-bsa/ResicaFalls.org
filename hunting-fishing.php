	...
	<body>
		...
		<div class="container content">
			<div class="row">
				<div class="col-md-8">
					<h1>Fishing</h1>
					<div class="alert alert-highlight mb-3">
					Due to the relationship of our property to our business and that of the restrictions the government is advising on Coronavirus, we have to remain closed to hunting and fishing for the time being.
                    </div>
					<p>
						...
						<ul>
							...
							<li>PA State Fishing License is also required</li>
							<li>Valid only on 6 miles of Bushkill Creek; location on the Cradle of Liberty Council Property.</li>
					...
					<h1>Hunting</h1>
					<p>
						More info coming soon. For now let us know you're interested on our <a href="contact-us">contact form</a> and we'll get back to you shortly.
					</p>
				</div>
				<div class="col-md-4">
					<img class="img-fluid rounded" src="_img/generic/fly_fishing.jpg" alt="">
				</div>
			</div>
		</div>
