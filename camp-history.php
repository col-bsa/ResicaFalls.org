	...
	<body>
		...
		<div class="container content">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<img class="img-fluid rounded" src="_img/history/camp_history-1.jpg" alt="">
					<br><br>
					<img class="img-fluid rounded" src="_img/history/camp_history-2.jpg" alt="">
					<br><br>
					<img class="img-fluid rounded" src="_img/history/camp_history-3.jpg" alt="">
				</div>
			</div>
		</div>
