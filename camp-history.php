...
<html lang="en">
	<head>
		...
		<meta name="description" content="Explore the history of Resica Falls Scout Reservation." />
		<title>Camp History <?php include '_inc/var/site_name.php'; ?></title>
	</head>
	<body>
