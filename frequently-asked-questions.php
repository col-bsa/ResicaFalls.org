						...
						<div class="card">
							...
							<div id="accordion2-collapse2" class="collapse" role="tabpanel" aria-labelledby="accordion2-question2">
								<div class="card-block">
									...
									<ul>
										<li>Campsite accommodations and facilities</li>
										<li>Program areas and supplies</li>
										<li>Three delicious meals each day</li>
										<li>An experienced, top-notch camp staff (salaries & training)</li>
										<li>Camp improvements and year-round maintence</li>
									</ul>
									and much, much more.
								</div>
							</div>
							...
							<div id="accordion2-collapse5" class="collapse" role="tabpanel" aria-labelledby="accordion2-question5">
								<div class="card-block">
									...
									<address>
										...
										Campsite Name<br>
										Resica Falls Scout Reservation<br>
											...
											<li>
												<ul>
													...
													<li>
														All other reasons:
														<ul>
															<li>Request submitted more than 30 days prior to camp: Forfeit 35% of camp fee, balance of fees refunded</li>
															<li>Request submitted less than 30 days prior to camp week: No refund</li>
														</ul>
													</li>
												</ul>
											</li>
