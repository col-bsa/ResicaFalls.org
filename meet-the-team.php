...
<html lang="en">
	<head>
		...
		<meta name="description" content="The team at Resica Falls Scout Reservation is passionate about what they do!" />
		<title>Meet The Team <?php include '_inc/var/site_name.php'; ?></title>
	</head>
	<body>
		...
		<div class="container content">
			...
			<div class="row split">
				...
				<div class="col-12 col-md-10">
					...
					<p>
					Bobby returns to the leadership team for his second summer Program Director. This is his 9th summer on camp staff, serving primarily on Aquatics staff. He is an Eagle Scout and Vigil Honor member of Unami Lodge, One, and works as a special education teacher. Bobby is filled with energy and enthusiasm for camp. Bobby enjoys telling "Dad jokes" in his free time. Contact Bobby at <a href="mailto:programdirector@resicafalls.org">programdirector@resicafalls.org</a>.
					</p>
				</div>
			</div>
			<div class="row split">
				...
				<div class="col-12 col-md-10">
					...
					<p>
					Andy brings 9 years of camp staff experience to the table in his second summer as Assistant Program Director. This Eagle Scout has previously worked as Civics Director and Program Commissioner. Andy is an integral part of the success of Resica Falls. Andy's favorite board game is Clue. Contact Andy at <a href="mailto:asstprogramdirector@resicafalls.org">asstprogramdirector@resicafalls.org</a>.
					</p>
				</div>
			</div>
			<div class="row split">
			...
			<div class="row split">
				...
				<div class="col-12 col-md-10">
					...
					<p>
						This is Nick's sixth summer as the Ranger at Resica Falls. An Eagle Scout and Vigil Honor member, Nick has worked in many different areas of camp over the past 17 years, including Handicraft, Dining Hall, QM, and spending two years as the Assistant Ranger at Musser Scout Reservation. Nick's work ethic has been vital to camp since his return to Resica in 2015. Nick's favorite food is bear meat. Contact Nick at <a href="mailto:nicholas.mckee@scouting.org">nicholas.mckee@scouting.org</a>.
					</p>
				</div>
			</div>
			<div class="row split">
				<div class="hidden-sm-down col-md-2">
					<img class="img-fluid rounded" src="_img/profiles/john.jpg" alt="">
				</div>
				<div class="col-12 col-md-10">
					<h2>John Bickel <div class="h5">Director of Outdoor Adventures</div></h2>
					<p>
						John is an Eagle Scout and Vigil Honor member who previously served as the Dan Beard Director, Head Commissioner, and Program Director at Resica Falls. After two summers as the Camp Director at Musser Scout Reservation, this former Lodge Chief took a break from our camping operations, while also continuing to serve on National Camping School staff. A professional scouter, John has served the Cradle of Liberty Council in a variety of positions, including district executive, council program director, and senior development director. John's favorite football team is the Philadelphia Eagles. Contact John at <a href="mailto:john.bickel@scouting.org">john.bickel@scouting.org</a>.
					</p>
				</div>
			</div>
		</div>
