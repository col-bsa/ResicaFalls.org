<nav class="navbar navbar-inverse bg-inverse navbar-toggleable-md">
	...
	<div class="collapse navbar-collapse justify-content-md-center" id="navbar">
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="coming-soon" id="dropdown_WeekendCamping" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Weekend<br class="hidden-md-down"> Camping</a>
...
<div class="alert alert-highlight text-center" role="alert">
	This property is closed to all events and activities (including fishing) until Thursday, April 30th. Summer Camp is still proceeding as planned!<br>For the latest updates regarding council events and camps, please visit <a class="alert-link" href="http://colbsa.org/coronavirus">colbsa.org/coronavirus</a>.
</div>
